...
class HostingFeatures {
  static const HostingFeatureSpec nginxConfig = HostingFeatureSpec(
    ...
    title: 'Nginx Config',
    subtitle: 'Kelola sites-available lalu aktifkan ke sites-enabled',
    icon: Icons.webhook_rounded,
    accentColor: Color(0xFF0F766E),
    primaryLabel: 'Config Path',
    primaryHint: 'sites-available/app.conf',
    secondaryLabel: 'Server Name',
    secondaryHint: 'app.example.com',
    tertiaryLabel: 'Status Section',
    tertiaryHint: 'available / enabled',
    descriptionLabel: 'Config Block',
    descriptionHint: 'server { ... }',
  ...
  static const HostingFeatureSpec subdomain = HostingFeatureSpec(
    ...
    primaryHint: 'app.example.com',
    secondaryLabel: 'Hostname',
    secondaryHint: 'localhost:80',
    tertiaryLabel: 'Tunnel',
    tertiaryHint: 'cloudflared-tunnel',
  ...
  static const HostingFeatureSpec domain = HostingFeatureSpec(
    ...
    title: 'Domain',
    subtitle: 'Daftar domain dan nameserver dummy Cloudflare',
  ...
  static const HostingFeatureSpec project = HostingFeatureSpec(
    ...
    title: 'Project',
    subtitle: 'CRUD proyek hosting dan deployment',
  ...
  static const HostingFeatureSpec otherServices = HostingFeatureSpec(
    ...
    subtitle: 'Layanan pendukung, link, dan dokumentasi',
    icon: Icons.widgets_rounded,
    accentColor: Color(0xFF0EA5E9),
    primaryLabel: 'Link',
    primaryHint: 'https://service.example.com',
    secondaryLabel: 'Kategori',
    secondaryHint: 'backup / docs / billing',
    tertiaryLabel: 'Owner',
    tertiaryHint: 'Tim Operasional',
    descriptionLabel: 'Deskripsi',
    descriptionHint: 'Jelaskan fungsi layanan ini',
    statusOptions: ['active', 'paused', 'maintenance'],
    defaultStatus: 'active',
    showEnabledToggle: false,
    descriptionMultiline: true,
    descriptionLines: 4,
  ...
  static const HostingFeatureSpec server = HostingFeatureSpec(
    ...
    secondaryLabel: 'Role',
    secondaryHint: 'primary / backup / worker',
