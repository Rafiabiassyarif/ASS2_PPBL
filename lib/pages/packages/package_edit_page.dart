    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Paket hosting berhasil diperbarui'), backgroundColor: Colors.green),
        );
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Gagal memperbarui paket: $e'), backgroundColor: Colors.redAccent),
        );
      }
    }
  }
